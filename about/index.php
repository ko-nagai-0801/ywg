          ...
          <table class="table table-bordered about-table mx-auto">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <ul class="about-table__list list-unstyled mb-0" aria-label="事業内容一覧">
                    <li>海外輸出入業</li>
              ...
              <tr>
                ...
                <td>
                  <ul class="about-table__list list-unstyled mb-0" aria-label="取引銀行一覧">
                    <li>みずほ銀行 横浜中央支店</li>
                    <li>横浜信用金庫 野毛町支店</li>
                  </ul>
                </td>
              ...
              <tr>
                ...
                <td>
                  <ul class="about-table__list list-unstyled mb-0" aria-label="加盟団体一覧">
                    <li>横浜商工会議所</li>
                    <li>横浜中法人会</li>
                    <li>守成クラブ</li>
                  </ul>
              ...
              <tr>
                ...
                <td>
                  <ul class="about-table__list list-unstyled mb-0" aria-label="グループ会社一覧">
                    <li>928合同会社</li>
                    <li>ビューティーサロン月の雫</li>
                    <li>earth協同組合</li>
